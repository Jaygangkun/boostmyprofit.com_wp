...
?>
	<li class="<?php echo ( $reference === 'chat' ? '' : ''); ?>">
		<a href="<?php codesquare_workintry_profile_menu_link($profile_page, 'chat', $user_identity, '', 'profile'); ?>"><i class="lnr lnr-envelope"></i>			
			<span><?php esc_html_e('Messages', 'workintry'); ?></span>
			<span class="cp-chat-count"></span>
		</a> 		
	</li>
<?php 