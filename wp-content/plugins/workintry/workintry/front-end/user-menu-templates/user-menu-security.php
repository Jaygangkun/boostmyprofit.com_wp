...
?>
	<li class="<?php echo ( $reference === 'security' ? '' : ''); ?>">
		<a href="<?php codesquare_workintry_profile_menu_link($profile_page, 'security', $user_identity, '', 'security'); ?>"><i class="lnr lnr-lock"></i>
			<span><?php esc_html_e('Security Settings', 'workintry'); ?></span>
		</a> 		
	</li>
<?php 