...
?>			
	<li>
		<a href="<?php codesquare_workintry_profile_menu_link($profile_page, 'expenses', $user_identity, '', 'expenses', ''); ?>"><i class="lnr lnr-chart-bars"></i>			
			<span><?php esc_html_e('Expenses', 'workintry'); ?></span>
		</a> 		
	</li>	
<?php 