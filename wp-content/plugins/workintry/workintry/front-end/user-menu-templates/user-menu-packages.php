...
?>
	<li class="<?php echo ( $reference === 'packages' ? 'active' : ''); ?>">
		<a href="<?php codesquare_workintry_profile_menu_link($profile_page, 'packages', $user_identity, '', 'profile'); ?>"><i class="lnr lnr-cart"></i>
			<span><?php esc_html_e('Packages', 'workintry'); ?></span>
		</a> 		
	</li>
<?php 