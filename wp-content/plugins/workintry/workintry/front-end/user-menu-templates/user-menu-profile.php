...
?>
	<li class="<?php echo ( $reference === 'profile' ? 'active' : ''); ?>">
		<a href="<?php codesquare_workintry_profile_menu_link($profile_page, 'profile', $user_identity, '', 'profile'); ?>"><i class="lnr lnr-user"></i>			
			<span><?php esc_html_e('Profile Settings', 'workintry'); ?></span>
		</a> 		
	</li>
<?php 