...
?>
	<li class="<?php echo ( $reference === 'favourite' ? '' : ''); ?>">
		<a href="<?php codesquare_workintry_profile_menu_link($profile_page, 'favourite', $user_identity, '', 'profile'); ?>"><i class="lnr lnr-heart"></i>			
			<span><?php esc_html_e('Favourite Gigs', 'workintry'); ?></span>
		</a> 		
	</li>
<?php 