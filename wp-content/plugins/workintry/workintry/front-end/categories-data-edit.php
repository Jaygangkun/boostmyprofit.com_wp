...
<?php
	...
	<div id="gig-cat0" class="gig-cat0 hidden-cat">
		...
		if( !empty( $terms ) ){
			...
			?>
				<option class="gig-cat<?php echo esc_attr( $value->term_id );  ?>" value="<?php echo esc_attr( $value->slug ); ?>" <?php selected($value->slug, $selected_category); ?>><?php echo esc_html( $value->name ); ?></option>
			<?php 	
		} }?>
		</select>
	</div>
